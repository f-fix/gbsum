...
⣿⢆⢸⡇⣛⢀⡀⣀⠠⣶⠄⣀⣀⠀⣀⢀⡀⠀⣀⣸⡇⢀⣀⡀
```
... followed by a display of the rest of the logo data. _(The language designator "Japanese" for this particular cartridge is a little fictitious, but that's at least what the developers were aiming for the appearance of.)_
